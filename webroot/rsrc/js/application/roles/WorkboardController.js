...
JX.install('WorkboardController', {
  ...
  members: {
    ...
    _setupCoverImageHandlers: function() {
      ...
      var drop = new JX.PhabricatorDragAndDropFileUpload('role-card')
    ...
    _oncoverupload: function(file) {
      ...
      var column_node = JX.DOM.findAbove(node, 'ul', 'role-column');
    ...
    _setupEditHandlers: function() {
      ...
      JX.Stratcom.listen('click', 'edit-role-card', onedit);
    },
    ...
    _oneditcard: function(e) {
      ...
      var column_node = e.getNode('role-column');
      var column_phid = JX.Stratcom.getData(column_node).columnPHID;
