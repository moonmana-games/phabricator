/**
 * @provides javelin-behavior-role-boards
...
JX.behavior('role-boards', function(config, statics) {

  function update_statics(update_config) {
    statics.boardID = update_config.boardID;
    statics.rolePHID = update_config.rolePHID;
  ...
  var board_phid = config.rolePHID;
