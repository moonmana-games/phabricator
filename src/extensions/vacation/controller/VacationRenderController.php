...
final class VacationRenderController extends PhabricatorController {
  ...
  private function getRequestHandler($request) {
      ...
      if (strcmp($panelType, VacationPanelType::MAIN) == 0) {
          return new VacationMainPanelRequestHandler();
      }
      if (strcmp($panelType, VacationPanelType::SUMMARY) == 0) {
          return new VacationSummaryPanelRequestHandler();
      }
      if (strcmp($panelType, VacationPanelType::DAY_DETAILS) == 0) {
          return new VacationDayDetailsRequestHandler();
      }
      return null;
  }
}
