...
final class PhabricatorRoleTriggerEditController
  ...
  public function handleRequest(AphrontRequest $request) {
    ...
    if ($id) {
      ...
      $trigger = PhabricatorRoleTrigger::initializeNewTrigger();
    }
    ...
    if ($request->isFormPost()) {
      try {
        ...
        $xactions[] = $trigger->getApplicationTransactionTemplate()
          ->setTransactionType(
            PhabricatorRoleTriggerNameTransaction::TRANSACTIONTYPE)
          ->setNewValue($v_name);
        ...
        $xactions[] = $trigger->getApplicationTransactionTemplate()
          ->setTransactionType(
            PhabricatorRoleTriggerRulesetTransaction::TRANSACTIONTYPE)
        ...
        if ($column) {
          ...
          $column_xactions[] = $column->getApplicationTransactionTemplate()
            ->setTransactionType(
              PhabricatorRoleColumnTriggerTransaction::TRANSACTIONTYPE)
  ...
  private function setupEditorBehavior(
    PhabricatorRoleTrigger $trigger,
    array $rule_list,
    $form_id,
    $table_id,
    $create_id,
    ...
    $type_list = PhabricatorRoleTriggerRule::getAllTriggerRules();
