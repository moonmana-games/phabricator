...
abstract class PhabricatorRoleColumnOrder
  extends Phobject {
  ...
  final public function getHeadersForObjects(array $objects) {
    ...
    assert_instances_of($headers, 'PhabricatorRoleColumnHeader');
  ...
  final protected function newHeader() {
    return id(new PhabricatorRoleColumnHeader())
      ->setOrderKey($this->getColumnOrderKey());
  }

  final protected function newEffect() {
    return new PhabricatorRoleDropEffect();
  }
