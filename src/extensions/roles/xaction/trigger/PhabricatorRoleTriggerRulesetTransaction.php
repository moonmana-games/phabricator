...
final class PhabricatorRoleTriggerRulesetTransaction
  extends PhabricatorRoleTriggerTransactionType {
  ...
  public function validateTransactions($object, array $xactions) {
    ...
    foreach ($xactions as $xaction) {
      ...
      try {
        $rules =
          PhabricatorRoleTrigger::newTriggerRulesFromRuleSpecifications(
            $ruleset,
            $allow_invalid = false,
            $actor);
      } catch (PhabricatorRoleTriggerCorruptionException $ex) {
