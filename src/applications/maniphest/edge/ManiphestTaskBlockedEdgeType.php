...
final class ManiphestTaskBlockedEdgeType extends PhabricatorEdgeType {
  const EDGECONST = 8;
  ...
  public function getConduitName() {
    return pht('Blocked Task');
  }

  public function getConduitDescription() {
    return pht('The source object has the destination object as a blocked.');
  }
