...
final class PhabricatorRoleBoardDefaultController
  extends PhabricatorRoleBoardController {

  public function handleRequest(AphrontRequest $request) {
    $viewer = $request->getViewer();

    $response = $this->loadRoleForEdit();
    if ($response) {
      return $response;
    }
    ...
    switch ($target) {
      case 'filter':
        ...
        $xaction_type = PhabricatorRoleFilterTransaction::TRANSACTIONTYPE;
      ...
      case 'sort':
        ...
        $xaction_type = PhabricatorRoleSortTransaction::TRANSACTIONTYPE;
