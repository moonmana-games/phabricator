...
final class PhabricatorRoleTrigger
  ...
  public static function newTriggerRulesFromRuleSpecifications(
    ...
    $rule_map = PhabricatorRoleTriggerRule::getAllTriggerRules();
    ...
    if (!is_array($list)) {
      throw new PhabricatorRoleTriggerCorruptionException(
        pht(
    ...
    foreach ($list as $key => $rule) {
      ...
      $record = id(new PhabricatorRoleTriggerRuleRecord())
      ...
      if (!isset($rule_map[$record->getType()])) {
        ...
        $rule = new PhabricatorRoleTriggerUnknownRule();
      } else {
      ...
      try {
        ...
        $rule = id(new PhabricatorRoleTriggerInvalidRule())
          ->setRecord($record)
          ->setException($ex);
      }
  ...
  public function getPreviewEffect() {
    ...
    return id(new PhabricatorRoleDropEffect())
      ->setIcon('fa-cogs')
      ->setColor('blue')
      ->setIsHeader(true)
      ->setContent($header);
  ...
  public function attachUsage(PhabricatorRoleTriggerUsage $usage) {
    $this->usage = $usage;
    return $this;
  }
...
/* -(  PhabricatorApplicationTransactionInterface  )------------------------- */
  ...
  public function getApplicationTransactionEditor() {
    return new PhabricatorRoleTriggerEditor();
  }
  ...
  public function destroyObjectPermanently(
    ...
    $this->openTransaction();
      ...
      queryfx(
        ...
        new PhabricatorRoleTriggerUsage(),
        $this->getPHID());
