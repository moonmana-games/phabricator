...
abstract class PhabricatorRoleTriggerRule
  extends Phobject {
  ...
  final public function setRecord(PhabricatorRoleTriggerRuleRecord $record) {
  ...
  final public function setColumn(PhabricatorRoleColumn $column) {
    $this->column = $column;
    return $this;
  }
  ...
  final public function setTrigger(PhabricatorRoleTrigger $trigger) {
